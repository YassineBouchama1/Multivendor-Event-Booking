...
<a href="{{route('home.index')}}" class="text-center pr-4">Home</a>

            <div class="hidden md:flex items-center  w-2/4 h-12 rounded-full border-2 bg-[#F5F6FA] overflow-hidden text-[#D5D5D5]">
